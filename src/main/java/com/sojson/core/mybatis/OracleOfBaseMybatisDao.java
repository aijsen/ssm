...
import com.sojson.core.mybatis.page.OracleDialect;
import com.sojson.core.mybatis.page.Pagination;

@SuppressWarnings( { "unchecked" })
public class OracleOfBaseMybatisDao<T> extends SqlSessionDaoSupport {

	private String NAMESPACE;
	final static  Class<? extends Object> SELF = OracleOfBaseMybatisDao.class;
	protected final Log logger = LogFactory.getLog(OracleOfBaseMybatisDao.class);
	/**默认的查询Sql id*/
	final static String DEFAULT_SQL_ID = "findAll";
	/**默认的查询Count sql id**/
	final static String DEFAULT_COUNT_SQL_ID = "findCount";
	public OracleOfBaseMybatisDao() {
		try {
	...
	public Pagination findByPageBySqlId(String sqlId,
		...
		String page_sql = String.format(" where ROWNUM between  %s and %s", offset,pageSize);
	...
	private PreparedStatement getPreparedStatement(String sql,
		 ...
		 * 分页根据数据库分页
		 */
		OracleDialect o = new OracleDialect();
